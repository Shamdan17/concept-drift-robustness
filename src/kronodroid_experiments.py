...
from dataset import KronodroidDataset
...
def first_experiment():
    ...
    kronodroid_root = os.path.expanduser('~/Desktop/COMP530/concept-drift-robustness/Kronodroid')
    data = KronodroidDataset(kronodroid_root)
    dataset = "kronodroid"
